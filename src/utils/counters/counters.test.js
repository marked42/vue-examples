...
describe('processCountersResets', () => {
  ...
  it('should create new counter in nested structure if counter already exist', () => {
  ...
  it('should create new counter in nested structure if counter already exist using 0 as default value', () => {
    const counters = { test: [2] }
  ...
  it('should be able to create multiple new counters at once', () => {
    const counters = { test: [2] }
